...
// Вариант 12
//
// Численное решение уравнения методом хорд
...
double root_hord(double a, double b, double eps) {
    ...
    if (f_3(a) * f_3(b) > 0) {
        ...
        if (f_2(a) * f_2(b) > 0) {
            ...
            if (f_1(a) * f_1(b) > 0) {
                cout << "+" << endl;
                cout << "Метод хорд к отрезку [" << fixed << setprecision(4) << a << ";" << b << "] применим" << endl;
                double m1;
                double M1;
                ...
                cout << "-" << endl;
                cout << "Метод хорд к отрезку [" << fixed << setprecision(4) << a << ";" << b << "] не применим" << endl;
            }
        }
        else {
            cout << "-" << endl;
